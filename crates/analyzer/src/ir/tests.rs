...
fn r#struct() {
  ...
  comb {
    var1[32'h00000000+:32'h00000002] = 32'sh00000001;
  }
}
"#;
...
module ModuleB {
  ...
  comb {
    var2[32'h00000002+:32'h00000002] = var2[32'h00000000+:32'h00000002];
  }
  inst u0 (
  ...
  inst u1 (
    var1 -> var2[32'h00000000+:32'h00000002];
  ) {
    module ModuleA {
      output var1(o): struct {x: logic<1>, y: logic<1>} = 2'hx;
...
fn union() {
  ...
  comb {
    var0[32'h00000000+:32'h00000003] = var0[32'h00000000+:32'h00000003];
    var0[32'h00000003] = var0[32'h00000003];
    var0[32'h00000004+:32'h00000003] = var0[32'h00000004+:32'h00000003];
    var0[32'h00000007] = var0[32'h00000007];
    var0[32'h00000000+:32'h00000002] = var0[32'h00000000+:32'h00000002];
    var0[32'h00000002+:32'h00000006] = var0[32'h00000002+:32'h00000006];
    var0[32'h00000000+:32'h00000008] = var0[32'h00000000+:32'h00000008];
    ...
    var0[32'h00000000+:32'h00000004] = var0[32'h00000000+:32'h00000004];
    var0[32'h00000000] = var0[32'h00000000];
    ...
    module ModuleA {
      ...
      ff (var0, var1) {
        if_reset {
          ...
          var3[32'h00000000+:32'h00000020] = 32'sh00000000;
        }
      }
    }
  }
